...
<head>
    ...
    <title>{{ config('app.name', 'Transcript System') }} - Confirm Password</title>
...
<body class="font-sans antialiased bg-gray-50">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            <div class="flex justify-center mb-8">
                <div class="text-center">
                    <h1 class="text-3xl font-bold gradient-text mb-1">Confirm Password</h1>
                    <p class="text-gray-500 text-sm">Please confirm your password before continuing</p>
                </div>
            </div>
        ...
        <div class="mt-8 text-center text-sm text-gray-500">
            &copy; {{ date('Y') }} Printrt Management System. All rights reserved.
        </div>
    </div>
</body>
</html>
